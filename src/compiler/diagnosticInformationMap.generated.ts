...
module ts {
    export var Diagnostics = {
        ...
        The_right_hand_side_of_an_arithmetic_operation_must_be_of_type_any_number_i32_or_an_enum_type: { code: 2112, category: DiagnosticCategory.Error, key: "The right-hand side of an arithmetic operation must be of type 'any', 'number', 'i32' or an enum type." },
        The_left_hand_side_of_an_arithmetic_operation_must_be_of_type_any_number_i32_or_an_enum_type: { code: 2113, category: DiagnosticCategory.Error, key: "The left-hand side of an arithmetic operation must be of type 'any', 'number', 'i32' or an enum type." },
        An_arithmetic_operand_must_be_of_type_any_number_i32_or_an_enum_type: { code: 2114, category: DiagnosticCategory.Error, key: "An arithmetic operand must be of type 'any', 'number', 'i32' or an enum type." },
